...
**Tested on Gradle versions from <!--property:gradle-api.min-version-->8.10<!--/property--> to <!--property:gradle-api.max-version-->8.11<!--/property-->.**

# `name.remal.insert-null-checks` plugin
